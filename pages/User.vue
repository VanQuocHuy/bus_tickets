    ...
    <div class="User">
      ...
      <div class="content-in4">
        <div v-if="activeTab === 'info'">
          ...
          <div class="edit-in4">
            <div class="user-container-img">
                 <img class="user-container-avatar" :src="newAvatarUrl ? newAvatarUrl : user?.data?.avatarUrl ? user?.data?.avatarUrl : '/images/avatar-default.svg'" alt="Avatar">
                 <input type="file" ref="fileInput" @change="onFileSelected" style="display: none;">
                 <button class="change-avatar-btn" @click="openFileDialog($event)">Chọn ảnh</button>
                 <button v-if="newAvatarUrl" class="change-avatar-btn" @click="openFileDialog($event)">Cập nhật</button>
            </div>
            ...
            <div class="user-container-information">
             ...
             <div class="user-container-info-item">
              ...
              <span>{{user?.data?.money.toLocaleString('vi-VN') + ' VND'}}</span>
             </div>
        ...
        <div v-if="activeTab === 'history'">
          <div class="history-tickets" style="color: red; font-size: 23px; text-align: center;">Lịch sử đặt vé</div>
          <hr class="lane">
          <div class="select-tickets" style="display: flex; margin-top:3%">
            <div class="ticket-field">
                <p>Mã vé</p>
                <input type="text" placeholder="Nhập mã vé" class="ticket-input">
            </div>
    ...
    <tbody>
      ...
      <tr>
        ...
        <div v-if="activeTab === 'reset'">
          <div class="change" style="color: red; font-size: 23px; text-align: center; margin-bottom: 2%;">Đặt lại mật khẩu</div>
          <div class="reset-password">
            <h3>(+84) 0845445797</h3>
            <div class="password-change">
              <p>Mật khẩu cũ</p>
              <div class="password-field">
                <input :type="showOldPassword ? 'text' : 'password'" v-model="oldPassword" placeholder="Nhập mật khẩu cũ">
                <button class="toggle-password" @click="togglePassword('old')">
                  <img :src="showOldPassword ? '/images/eye.svg' : '/images/eye-slash.svg'" alt="Toggle Password">
                </button>
              </div>
            </div>
            ...
            <div class="password-change">
              <p>Mật khẩu mới</p>
              <div class="password-field">
                <input :type="showNewPassword ? 'text' : 'password'" v-model="newPassword" placeholder="Nhập mật khẩu mới">
                <button class="toggle-password" @click="togglePassword('new')">
                  <img :src="showNewPassword ? '/images/eye.svg' : '/images/eye-slash.svg'" alt="Toggle Password">
                </button>
              </div>
            </div>
            ...
            <div class="password-change">
              ...
              <div class="password-field">
                <input :type="showConfirmPassword ? 'text' : 'password'" v-model="confirmPassword" placeholder="Xác nhận mật khẩu mới">
                <button class="toggle-password" @click="togglePassword('confirm')">
                  <img :src="showConfirmPassword ? '/images/eye.svg' : '/images/eye-slash.svg'" alt="Toggle Password">
                </button>
              </div>
            </div>
            <div class="reset-password-button-container">
               <button class="changes-success" style="margin-bottom: 3%;" @click="changePassword">Đổi mật khẩu</button>
             </div>
            </div>
        </div>
      </div>
  ...
  methods: {
    async changePassword() {
      ...
      try {
        ...
        const response = await this.$store.dispatch('userStore/changePassword', {
