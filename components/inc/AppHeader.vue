      ...
      <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="dn_dk" v-if="currentUser">
                <img :src="currentUser.avatarUrl ? currentUser.avatarUrl : '/images/avatar-default.jpg'" alt="" class="icon-profile"> 
                <span>{{currentUser?.fullName}}</span>
            </div>
            <NuxtLink to="/login" class="dn_dk" v-if="!currentUser">
