...
methods: {
 ...
 <style>
 /* Cập nhật các thuộc tính cho các phần tử để phù hợp với màn hình khác nhau */

/* Style cho các màn hình lớn hơn */
@media (min-width: 1024px) {
  .options-box {
    width: 1100px; /* Chiều rộng cố định cho màn hình lớn */
  }

  .field-group {
    flex: 1; /* Cho phép các phần tử linh hoạt */
  }

  .form-fields {
    flex-wrap: nowrap; /* Không cho phép gói gọn */
  }

  .search {
    width: 250px; /* Chiều rộng cố định cho nút tìm kiếm */
  }
}

/* Style cho các màn hình trung bình */
@media (max-width: 1024px) and (min-width: 768px) {
  .options-box {
    width: 80%; /* Chiều rộng linh hoạt cho màn hình trung bình */
  }

  .field-group {
    flex: 1 1 45%; /* Cho phép các phần tử co dãn và thay đổi kích thước */
  }

  .form-fields {
    flex-wrap: wrap; /* Cho phép gói gọn khi cần */
  }

  .search {
    width: 200px; /* Chiều rộng nhỏ hơn cho nút tìm kiếm */
  }
}

/* Style cho các màn hình nhỏ hơn */
@media (max-width: 768px) {
  .options-box {
    width: 100%; /* Chiều rộng đầy đủ cho màn hình nhỏ */
  }

  .field-group {
    flex: 1 1 100%; /* Chiều rộng đầy đủ cho các phần tử */
    margin-bottom: 15px; /* Khoảng cách giữa các phần tử */
  }

  .form-fields {
    flex-direction: column; /* Xếp chồng các phần tử */
    align-items: stretch; /* Mở rộng các phần tử để lấp đầy chiều rộng */
  }

  .search {
    width: 100%; /* Chiều rộng đầy đủ cho nút tìm kiếm */
  }

  .banner-img {
    max-height: 250px; /* Giới hạn chiều cao tối đa của banner cho màn hình nhỏ */
  }

  .number-visitors {
    width: 100%; /* Chiều rộng đầy đủ cho các phần tử số lượt khách */
    height: auto; /* Chiều cao tự động */
    margin-left: 0; /* Xóa khoảng cách bên trái */
  }

  .Slogan4 {
    margin-top: 20px; /* Điều chỉnh khoảng cách trên cho màn hình nhỏ */
    margin-right: 10px; /* Điều chỉnh khoảng cách bên phải */
  }
}

/* Style cho các phần tử có chung thuộc tính */
.error-message {
  color: red;
  font-size: 14px;
  margin-top: 5px;
