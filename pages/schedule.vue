      ...
      <div class="form-fields">
        <div class="field-group">
          ...
          <input
            ...
            v-model="departure"
          />
          <p v-if="errors.departure" class="error-message">
            {{ errors.departure }}
          </p>
        </div>
        ...
        <div class="field-group">
          ...
          <input
            ...
            v-model="destination"
          />
          <p v-if="errors.destination" class="error-message">
            {{ errors.destination }}
          </p>
        </div>
        ...
        <div class="field-group">
          ...
          />
          <p v-if="errors.departureDate" class="error-message">
        ...
        <div class="field-group" v-if="isRoundTrip === 'round-trip'">
          ...
          <input
            ...
            v-model="returnDate"
          />
          <p v-if="errors.returnDate" class="error-message">
            {{ errors.returnDate }}
          </p>
        </div>
        ...
        <div class="field-group">
          ...
          <input
            ...
            step="1"
          />
          <p v-if="errors.ticketNumber" class="error-message">
            {{ errors.ticketNumber }}
          </p>
        </div>
      </div>
