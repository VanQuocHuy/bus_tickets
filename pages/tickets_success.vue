...
/* Container của vé - dùng flex và overflow-x để tạo cuộn ngang */
.tiket {
  margin-top: 2%;
  width: 100%;
  border-radius: 10px;
...
/* Định dạng phần chứa thông tin vé */
.in4-tickets {
...
/* Căn chỉnh thông tin thành công */
.success {
  display: flex;
  flex-direction: column;
  align-items: center;
...
/* Responesive cho các màn hình nhỏ hơn */
